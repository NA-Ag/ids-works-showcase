    ...
    <div className="space-y-8 animate-fade-in">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-md shadow-sm border border-gray-200 overflow-hidden flex flex-col">
                <div className="p-6 border-b border-gray-100 bg-[#f8fafc] flex justify-between items-center">
                    <div className="flex gap-4 items-center">
                        <Database size={20} className="text-vault-blue" />
                        <h3 className="font-black text-vault-darkBlue uppercase tracking-tighter italic text-sm">
                            {isEn ? 'Digital Sovereignty Audit' : 'Auditoría de Soberanía Digital'}
                        </h3>
                    </div>
                    <span className="px-3 py-1 bg-vault-yellow text-vault-darkBlue rounded-full text-[9px] font-black uppercase tracking-widest shadow-sm">Audit: Passed</span>
                </div>
                <div className="p-8 space-y-6 flex-grow">
                    {[
                        ...
                        <div key={i} className="flex items-center justify-between group">
                            <div className="flex gap-4 items-center">
                                <div className="p-2 bg-gray-50 rounded-lg group-hover:bg-vault-blue group-hover:text-white transition-colors">
                                    <item.icon size={16} />
                                </div>
                                <span className="text-xs font-bold text-gray-600 group-hover:text-vault-darkBlue transition-colors">{item.label}</span>
                            </div>
            ...
            <div className="bg-white rounded-md shadow-sm border border-gray-200 overflow-hidden flex flex-col">
                <div className="p-6 border-b border-gray-100 bg-[#f8fafc] flex justify-between items-center">
                    <div className="flex gap-4 items-center">
                        <Globe size={20} className="text-vault-blue" />
                        <h3 className="font-black text-vault-darkBlue uppercase tracking-tighter italic text-sm">
                    ...
                    {[
                        ...
                        <div key={i} className="flex items-center justify-between p-3 bg-gray-50 rounded border border-gray-100 group hover:border-vault-blue transition-all">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <Settings size={14} className="text-gray-300 group-hover:text-vault-blue cursor-pointer" />
                            </div>
                        </div>
                    ))}
                </div>
        ...
        <div className="bg-vault-darkBlue rounded-md shadow-sm p-8 text-white flex flex-col justify-between relative overflow-hidden group">
            <div className="relative z-10 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <button className="flex items-center justify-center gap-3 px-6 py-3 bg-white/10 border border-white/20 text-white rounded-sm text-[10px] font-black uppercase tracking-widest hover:bg-white hover:text-vault-darkBlue transition-all">
                    ...
                    <button 
                        ...
                        className="flex items-center justify-center gap-3 px-6 py-3 bg-vault-yellow text-vault-darkBlue rounded-sm text-[10px] font-black uppercase tracking-widest hover:bg-white transition-all shadow-xl"
                    >
