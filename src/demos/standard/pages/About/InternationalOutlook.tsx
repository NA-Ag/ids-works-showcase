      ...
      <div className="space-y-24 animate-fade-in">
        ...
        <section className="space-y-12">
            <div className="relative rounded-[3rem] overflow-hidden shadow-2xl h-[400px] md:h-[500px] border-8 border-white group">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-vault-darkBlue/80 via-transparent to-transparent flex items-end p-12">
        ...
        <section className="bg-gray-50 -mx-4 lg:-mx-12 px-4 lg:px-12 py-24 border-y border-gray-100">
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-black text-vault-darkBlue uppercase tracking-tighter italic mb-4">{content.partnersTitle}</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {data.internationalOutlook.partnerships.map((partner: any, idx: number) => (
                        <div key={idx} className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all border-b-8 hover:border-vault-blue flex flex-col items-center text-center">
                            <div className="bg-vault-blue/10 p-4 rounded-2xl text-vault-blue mb-6">
                                <Briefcase size={32} />
                            </div>
                            <h4 className="text-xl font-black text-vault-darkBlue uppercase tracking-tight mb-1 italic">{partner.name}</h4>
                            <p className="text-[10px] font-black text-vault-blue uppercase tracking-widest mb-4">{partner.type}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-8 bg-vault-darkBlue p-12 rounded-[3rem] border-b-8 border-vault-yellow shadow-xl hover:-translate-y-1 transition-all text-white relative overflow-hidden group">
            ...
            <div className="space-y-8 bg-vault-blue p-12 rounded-[3rem] border-b-8 border-vault-yellow shadow-xl hover:-translate-y-1 transition-all text-white relative overflow-hidden group">
        ...
        <section className="pt-8">
            <div className="flex items-center justify-between mb-12 border-b-4 border-gray-100 pb-6">
                ...
                <div className="flex items-center gap-2 font-mono text-[10px] font-black text-vault-blue tracking-widest">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {galleryImages.map((img, idx) => (
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-vault-darkBlue/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
        ...
        {selectedImg !== null && (
            <div 
                className="fixed inset-0 z-[200] bg-vault-darkBlue/95 backdrop-blur-md flex items-center justify-center p-4 md:p-12"
