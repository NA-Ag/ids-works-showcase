    ...
    >
      <div className="flex flex-col md:flex-row gap-12 items-start animate-fade-in mb-24">
        ...
        <div className="md:w-3/5 space-y-10">
            <p className="text-3xl font-black text-vault-darkBlue uppercase tracking-tighter leading-tight italic">
                "{content.intro}"
            </p>
            ...
            <div className="bg-vault-darkBlue p-10 rounded-[3rem] text-white shadow-2xl relative overflow-hidden group border-b-8 border-vault-yellow">
        ...
        <div className="md:w-2/5 space-y-8">
            <div className="grid grid-cols-1 gap-6">
                <div className="bg-gray-50 p-10 rounded-[2.5rem] border border-gray-100 text-center hover:border-vault-yellow transition-all group shadow-sm">
                    <p className="text-6xl font-black text-vault-darkBlue group-hover:scale-110 transition-transform">100</p>
      ...
      <div className="pt-24 border-t-2 border-gray-100">
        <h3 className="text-3xl font-black text-vault-darkBlue uppercase tracking-tighter italic mb-12 text-center">
