      ...
      <section className="relative h-[70vh] flex items-center bg-[#FDFBF7] overflow-hidden pt-20 border-b-2 border-gray-100">
          ...
          <div className="container mx-auto px-4 lg:px-12 relative z-20">
              <div className="max-w-4xl space-y-10">
                  <div className="inline-flex items-center gap-3 bg-vault-darkBlue text-white px-6 py-2 rounded-sm font-black text-[10px] tracking-[0.4em] uppercase shadow-lg">
                      <GraduationCap size={14} className="text-vault-yellow" /> {isEn ? 'UPPER SECONDARY DIVISION' : 'DIVISIÓN PREPARATORIA'}
                  </div>
                  
                  <h1 className="text-6xl md:text-[110px] font-black leading-[0.85] text-vault-darkBlue uppercase tracking-tighter italic">
                      {isEn ? "LEGACY &" : "LEGADO Y"}<br/>
                      <span className="text-vault-yellow underline decoration-vault-darkBlue/10 underline-offset-8">SUCCESS</span>
                  </h1>
                  ...
                  <div className="pt-4">
                      <button 
                        ...
                        className="group flex items-center gap-8 bg-vault-darkBlue text-white px-12 py-6 rounded-sm hover:bg-vault-yellow hover:text-vault-darkBlue transition-all duration-500 shadow-2xl"
                      >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
                  {data.highSchool.stats.map((stat: any, idx: number) => (
                      <div key={idx} className="space-y-4 group p-8 rounded-2xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                          ...
                          <p className="text-6xl font-black text-vault-darkBlue italic tracking-tighter">
                              {stat.value}
                          </p>
                      </div>
                  ))}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-32">
                  <div className="space-y-10">
                      <div className="space-y-4">
                          ...
                          <div className="h-1.5 w-32 bg-vault-darkBlue"></div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 gap-4 pt-4">
                          {['Pedagogical Excellence', 'Curricular Integrity', 'Scholarly Research'].map((item, i) => (
                              <div key={i} className="flex items-center gap-4 text-vault-darkBlue font-black uppercase tracking-widest text-[11px] bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                  ...
                  <div className="relative">
                      ...
                      <div className="absolute -bottom-10 -right-10 bg-vault-darkBlue text-white p-10 rounded-2xl shadow-2xl border-b-8 border-vault-yellow hidden md:block">
                  ...
                  {data.highSchool.programs.map((program: any, idx: number) => {
                      ...
                      return (
                          <div 
                            ...
                            className="bg-white p-10 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-500 cursor-pointer group flex flex-col h-full border-b-8 hover:border-vault-darkBlue"
                          >
                              <div className="bg-gray-50 p-4 rounded-xl text-vault-darkBlue w-fit mb-8 group-hover:bg-vault-darkBlue group-hover:text-white transition-all">
                                  <Icon size={28} />
                              </div>
                              <h4 className="text-xl font-black text-vault-darkBlue uppercase tracking-tight italic mb-4">{program.title}</h4>
                              <p className="text-gray-500 text-sm font-medium leading-relaxed flex-grow">
                                  {program.desc}
                              </p>
                              <div className="mt-8 pt-6 border-t border-gray-50 flex items-center justify-between">
                                  <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest group-hover:text-vault-darkBlue transition-colors">Enquire</span>
      ...
      <section className="py-24 px-4 bg-white border-t border-gray-100">
          <div className="container mx-auto max-w-6xl text-center">
              <div className="space-y-12 mb-20">
                  <Library size={80} className="mx-auto text-vault-darkBlue opacity-20" />
                  <h2 className="text-5xl md:text-8xl font-black text-vault-darkBlue uppercase tracking-tighter leading-[0.9] italic">
                      ESTABLISH YOUR<br/>
              ...
              <Link 
                  ...
                  className="inline-block bg-vault-darkBlue text-white px-20 py-8 rounded-sm font-black uppercase tracking-[0.2em] text-lg hover:bg-vault-yellow hover:text-vault-darkBlue transition-all shadow-2xl transform hover:-translate-y-2 border-b-8 border-idsRed"
              >
