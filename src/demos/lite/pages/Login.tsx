...
const Login: React.FC = () => {
  const isEn = false; // Lite is fixed to Spanish per TierComparison
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 font-sans relative overflow-hidden" style={{
      ...
      <div className="absolute top-8 left-8 z-50 flex items-center gap-4">
        <Link to="/demos/lite" className="bg-white/80 backdrop-blur-md px-6 py-2.5 rounded-full shadow-lg border border-gray-200 text-vault-darkBlue flex items-center gap-2 hover:bg-white transition-all font-black uppercase tracking-widest text-[10px]">
