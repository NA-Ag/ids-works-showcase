...
const NAV_ITEMS_EN: NavItem[] = [
  { label: 'Home', href: '/demos/integrated' },
  { 
    label: 'About Us', 
    href: '#about', 
    subItems: [
      {label: 'Headmaster Welcome', href: '/demos/integrated/about-us/headmaster-welcome'}, 
      {label: 'Our History', href: '/demos/integrated/about-us/history'},
      {label: 'Mission & Vision', href: '/demos/integrated/about-us/mission-vision-values'},
      {label: 'Accreditations', href: '/demos/integrated/about-us/accreditations'},
      {label: 'International Outlook', href: '/demos/integrated/about-us/international-outlook'},
      {label: 'Campus & Environment', href: '/demos/integrated/about-us/unique-environment'},
      {label: 'School Library', href: '/demos/integrated/about-us/library'},
      {label: 'Inspection Reports', href: '/demos/integrated/about-us/inspection-reports'}
    ] 
  },
  { 
    label: 'Academic Offering', 
    href: '/demos/integrated/kinder',
    subItems: [
      {label: 'Kinder', href: '/demos/integrated/kinder'},
      {label: 'Primary', href: '/demos/integrated/primary'},
      {label: 'Secondary', href: '/demos/integrated/secondary'},
      {label: 'High School', href: '/demos/integrated/high-school'}
    ]
  },
  {
    label: 'Enrichment',
    href: '#',
    subItems: [
      {label: 'Kinder Co-Curricular', href: '/demos/integrated/plus/kinder'},
      {label: 'Primary Co-Curricular', href: '/demos/integrated/plus/primary'},
      {label: 'Secondary Co-Curricular', href: '/demos/integrated/plus/secondary'},
      {label: 'High School Co-Curricular', href: '/demos/integrated/plus/high-school'}
    ]
  },
  { 
    label: 'Admissions', 
    href: '/demos/integrated/admissions',
    subItems: [
      {label: 'Admissions Process', href: '/demos/integrated/admissions'},
      {label: 'Visit Our Campus', href: '/demos/integrated/about-us/unique-environment'},
      {label: 'Testimonials', href: '/demos/integrated/testimonials'}
    ] 
  },
  { label: 'Publications', href: '/demos/integrated/publications' },
  { label: 'Contact', href: '/demos/integrated/contact' },
  { 
    label: 'Intranet', 
    href: '/demos/integrated/login', 
    subItems: [
      {label: 'Student & Staff Portal', href: '/demos/integrated/login'},
      {label: 'Parent Portal', href: '/demos/integrated/login'},
      {label: 'Alumni Network', href: '/demos/integrated/login'}
    ] 
  },
];

const NAV_ITEMS_ES: NavItem[] = [
  { label: 'Inicio', href: '/demos/integrated' },
  { 
    label: 'Quiénes Somos', 
    href: '#about', 
    subItems: [
      {label: 'Bienvenida del Rector', href: '/demos/integrated/about-us/headmaster-welcome'}, 
      {label: 'Historia', href: '/demos/integrated/about-us/history'},
      {label: 'Misión y Visión', href: '/demos/integrated/about-us/mission-vision-values'},
      {label: 'Acreditaciones', href: '/demos/integrated/about-us/accreditations'},
      {label: 'Enfoque Internacional', href: '/demos/integrated/about-us/international-outlook'},
      {label: 'Plantel y Entorno', href: '/demos/integrated/about-us/unique-environment'},
      {label: 'Biblioteca', href: '/demos/integrated/about-us/library'},
      {label: 'Reportes de Inspección', href: '/demos/integrated/about-us/inspection-reports'}
    ] 
  },
  { 
    ...
    subItems: [
      {label: 'Kinder', href: '/demos/integrated/kinder'},
      {label: 'Primaria', href: '/demos/integrated/primary'},
      {label: 'Secundaria', href: '/demos/integrated/secondary'},
      {label: 'Preparatoria', href: '/demos/integrated/high-school'}
    ]
  },
  {
    label: 'Cocurricular',
    href: '#',
    subItems: [
      {label: 'Kinder Cocurricular', href: '/demos/integrated/plus/kinder'},
      {label: 'Primaria Cocurricular', href: '/demos/integrated/plus/primary'},
      {label: 'Secundaria Cocurricular', href: '/demos/integrated/plus/secondary'},
      {label: 'Preparatoria Cocurricular', href: '/demos/integrated/plus/high-school'}
    ]
  },
  { 
    label: 'Admisiones', 
    href: '/demos/integrated/admissions',
    subItems: [
      {label: 'Proceso de Admisión', href: '/demos/integrated/admissions'},
      {label: 'Visite Nuestro Campus', href: '/demos/integrated/about-us/unique-environment'},
      {label: 'Testimonios', href: '/demos/integrated/testimonials'}
    ] 
  },
  { label: 'Publicaciones', href: '/demos/integrated/publications' },
  { label: 'Contacto', href: '/demos/integrated/contact' },
  { 
    label: 'Intranet', 
    href: '/demos/integrated/login', 
    subItems: [
      {label: 'Portal Alumnos y Staff', href: '/demos/integrated/login'},
      {label: 'Portal de Padres', href: '/demos/integrated/login'},
      {label: 'Portal de Egresados', href: '/demos/integrated/login'}
    ] 
  },
];
...
const ACADEMIC_STAGES_EN: AcademicStage[] = [
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&q=80&w=800",
    link: "/demos/integrated/secondary"
  },
  {
    title: "High School",
