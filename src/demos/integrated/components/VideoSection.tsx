      ...
      <div className="container mx-auto px-4 lg:px-12 text-center">
        <div className="max-w-4xl mx-auto space-y-12">
            <div className="flex flex-col items-center gap-4">
                <Shield className="w-16 h-16 text-vault-wine opacity-20" />
                <h2 className="text-4xl md:text-5xl font-black text-vault-darkWine uppercase tracking-tighter italic">
            ...
            <div className="pt-8 font-mono text-[10px] font-black uppercase tracking-[0.5em] text-vault-wine/40">
