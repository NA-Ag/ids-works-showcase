                ...
                <div className="flex-grow overflow-hidden relative">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-12 text-white z-10">
                        <div className="max-w-xl space-y-6 animate-fade-in" key={title + bgImage}>
                            <div className="inline-block px-4 py-1 bg-vault-yellow text-vault-darkWine text-[10px] font-black uppercase tracking-[0.3em] mb-4 shadow-xl">Live Preview Mode</div>
                            ...
                            <div className="pt-8 flex justify-center gap-4">
                                <div className="px-8 py-3 bg-vault-yellow text-vault-darkWine text-[10px] font-black uppercase tracking-widest shadow-lg">Our Vision</div>
