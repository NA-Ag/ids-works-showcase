...
const AdmissionsPopup: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-vault-darkWine/80 backdrop-blur-md animate-fade-in">
      <div className="relative bg-white max-w-lg w-full rounded-3xl shadow-2xl overflow-hidden border-4 border-vault-yellow animate-scale-up">
        ...
        {/* Header Decor */}
        <div className="bg-vault-darkWine p-6 text-white flex items-center justify-between">
        ...
        <div className="p-10 text-center space-y-8">
            <div className="bg-gray-50 w-24 h-24 rounded-full flex items-center justify-center mx-auto border-2 border-vault-yellow">
                <GraduationCap size={40} className="text-vault-darkWine" />
            </div>
            
            <div className="space-y-4">
                <h3 className="text-3xl font-black text-vault-darkWine uppercase tracking-tighter italic">Join Our Community</h3>
            ...
            <a 
                ...
                onClick={() => setIsOpen(false)}
                className="block bg-vault-yellow text-vault-darkWine py-4 rounded-xl font-black uppercase tracking-widest text-sm hover:bg-vault-darkWine hover:text-white transition-all shadow-xl"
            >
                Apply Now
            </a>
        </div>
