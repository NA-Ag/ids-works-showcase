    ...
    >
      <div className="space-y-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-8">
            <section className="bg-vault-darkWine p-12 rounded-[3rem] text-white shadow-2xl relative overflow-hidden group border-b-8 border-vault-yellow">
            ...
            <section className="bg-vault-wine p-12 rounded-[3rem] text-white shadow-2xl relative overflow-hidden group border-b-8 border-vault-yellow">
        ...
        <section className="bg-gray-50 -mx-4 lg:-mx-12 px-4 lg:px-12 py-24 border-y border-gray-100">
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-black text-vault-darkWine uppercase tracking-tighter italic mb-4">{content.profile.title}</h2>
                    ...
                    {data.graduateProfile.map((item: any, idx: number) => {
                        ...
                        return (
                            <div key={idx} className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex gap-6 items-start hover:shadow-md transition-shadow">
                                <div className="bg-vault-wine/10 p-4 rounded-xl text-vault-wine shrink-0">
                                    <Icon size={32} />
                                </div>
                                <div>
                                    <h4 className="text-xl font-black text-vault-darkWine uppercase tracking-tight mb-2 italic">{item.title}</h4>
        ...
        {/* Values Section */}
        <section>
            <h2 className="text-3xl font-sans font-black text-vault-darkWine mb-6 border-l-4 border-vault-yellow pl-4 uppercase tracking-tighter italic">
                    ...
                    return (
                        <div key={value.name} className="bg-gray-50 p-8 rounded-[2rem] border border-gray-100 hover:shadow-xl transition-all group border-b-4 hover:border-vault-yellow">
                            <div className="flex items-center mb-6">
                                <div className="bg-white p-3 rounded-xl shadow-sm mr-4 group-hover:bg-vault-wine group-hover:text-white transition-colors">
                                    <IconComponent className="w-8 h-8" />
                                </div>
                                <h3 className="text-xl font-black text-vault-darkWine uppercase tracking-tight">{value.name}</h3>
                            </div>
        ...
        <div className="relative rounded-[3rem] overflow-hidden shadow-2xl h-[500px] border-8 border-white">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-vault-darkWine/80 via-transparent to-transparent flex items-end p-16">
