...
const Primary: React.FC = () => {
  ...
  return (
    ...
    <div className="bg-[#f8fafc] min-h-screen font-sans selection:bg-blue-100 overflow-hidden">
      ...
      {/* 1. Hero Section */}
      <section className="relative h-[600px] md:h-[750px] flex items-center overflow-hidden pt-20 bg-vault-darkWine">
          ...
          <div className="container mx-auto px-4 lg:px-12 relative z-20">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  <div className="space-y-10">
                      <div className="inline-flex items-center gap-3 bg-vault-yellow text-vault-darkWine px-6 py-2 rounded-sm font-black text-xs tracking-widest uppercase animate-bounce-slow">
                  ...
                  <div className="relative h-[400px] md:h-[500px] hidden lg:block animate-float">
                      <div className="absolute right-0 top-0 w-[85%] h-[80%] rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white/10 group">
                          ...
                          />
                          <div className="absolute inset-0 bg-vault-wine/20 mix-blend-overlay group-hover:opacity-0 transition-opacity"></div>
                      </div>
                      <div className="absolute left-0 bottom-0 w-[50%] h-[50%] bg-vault-yellow rounded-[2rem] shadow-2xl flex items-center justify-center p-8 border-8 border-vault-darkWine transform -rotate-6 hover:rotate-0 transition-transform duration-500 cursor-help group">
                          <Atom size={80} className="text-vault-darkWine group-hover:scale-125 transition-transform duration-700" />
                      </div>
                  </div>
              </div>
          </div>
      ...
      <section ref={welcomeRef} className="py-32 bg-white relative overflow-hidden">
          <div className="absolute -left-20 top-1/4 text-vault-wine/5 animate-spin-slow"><Atom size={300} /></div>
          ...
          <div className="container mx-auto px-4 lg:px-12 relative z-10">
              <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-20">
                  <div className="lg:w-1/2 space-y-8">
                      <h2 className="text-5xl font-black text-vault-darkWine uppercase tracking-tighter italic leading-tight">
                      ...
                      <div className="pt-4">
                          <button 
                            ...
                            className="group bg-vault-darkWine text-white px-10 py-4 rounded-sm font-black uppercase tracking-widest text-xs hover:bg-vault-wine transition-all flex items-center gap-3 shadow-lg hover:shadow-vault-wine/20"
                          >
                  ...
                  <div className="lg:w-1/2 grid grid-cols-2 gap-6 w-full">
                      {data.primary.stats.map((stat: any, idx: number) => (
                          <div key={idx} className="bg-vault-paper p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group text-center cursor-default">
                              <p className="text-5xl font-black text-vault-wine mb-2 italic tracking-tighter group-hover:text-vault-darkWine transition-colors">{stat.value}</p>
      ...
      <section className="bg-gray-50 py-32 border-y border-gray-100 relative">
          <div className="container mx-auto px-4 lg:px-12">
              <div className="text-center mb-20">
                  <h2 className="text-5xl font-black text-vault-darkWine uppercase tracking-tighter italic mb-4">{content.pillarsTitle}</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                  {data.primary.pillars.map((pillar: any, idx: number) => {
                      ...
                      return (
                          <div 
                            key={idx} 
                            className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 border-b-8 hover:border-vault-wine group hover:-rotate-1 cursor-default"
                          >
                              <div className="bg-vault-wine/5 p-4 rounded-2xl text-vault-wine w-fit mb-8 group-hover:bg-vault-darkWine group-hover:text-white group-hover:rotate-12 transition-all duration-500">
                                  <Icon size={32} />
                              </div>
                              <h4 className="text-2xl font-black text-vault-darkWine uppercase tracking-tight italic mb-4 group-hover:text-vault-wine transition-colors">{pillar.title}</h4>
      ...
      <section className="py-32 bg-white">
          <div className="container mx-auto px-4 lg:px-12">
              <div className="text-center mb-20">
                  <h2 className="text-5xl font-black text-vault-darkWine uppercase tracking-tighter italic mb-4">{content.levelsTitle}</h2>
                  <div className="h-1 w-24 bg-vault-wine mx-auto"></div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
                  {content.levels.map((level, idx) => (
                      <div key={idx} onClick={() => setSelectedStage(level)} className="group relative overflow-hidden rounded-[4rem] shadow-2xl h-[500px] border-8 border-white cursor-pointer">
                          ...
                          />
                          <div className="absolute inset-0 bg-gradient-to-t from-vault-darkWine/90 via-vault-darkWine/20 to-transparent flex flex-col justify-end p-16">
      ...
      <section className="py-20 px-4">
          <div className="container mx-auto max-w-6xl">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  {/* Admissions CTA */}
                  <div className="bg-vault-darkWine rounded-[4rem] p-12 md:p-16 text-center text-white relative overflow-hidden shadow-2xl border-b-8 border-vault-yellow group">
                      ...
                      <div className="relative z-10 space-y-8">
                          ...
                          <Link 
                              to="/demos/integrated/admissions" 
                              className="inline-block bg-vault-yellow text-vault-darkWine px-12 py-4 rounded-sm font-black uppercase tracking-widest text-xs hover:bg-white transition-all shadow-xl"
                          >
                  ...
                  {/* Enrichment Section */}
                  <div className="bg-white rounded-[4rem] p-12 md:p-16 text-center relative overflow-hidden shadow-2xl border border-gray-100 border-b-8 border-vault-wine group">
                      <div className="relative z-10 space-y-8">
                          <BookOpen size={48} className="mx-auto text-vault-wine" />
                          <h2 className="text-3xl md:text-4xl font-black text-vault-darkWine uppercase tracking-tighter italic">
                          ...
                          <Link 
                              to="/demos/integrated/plus/primary" 
                              className="inline-block bg-vault-wine text-white px-12 py-4 rounded-sm font-black uppercase tracking-widest text-xs hover:bg-vault-darkWine transition-all shadow-xl"
                          >
