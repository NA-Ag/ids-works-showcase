...
const Kinder: React.FC = () => {
  ...
  return (
    <div className="bg-[#FDFBF7] min-h-screen font-sans selection:bg-pink-200 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-20 flex flex-col items-center">
              ...
              <div className="relative mb-16 text-center">
                  <h1 className="text-7xl md:text-[140px] leading-none font-black drop-shadow-2xl animate-scale-up" style={{ letterSpacing: '-0.05em' }}>
                      <span className="text-vault-darkWine">{isEn ? "LEARN" : "APRENDE"}</span><br/>
                      <span className="text-pink-500 italic">&</span> 
                      <span className="text-vault-wine"> {isEn ? "PLAY" : "JUEGA"}</span>
                  </h1>
                  ...
                  <button 
                    ...
                    className="mt-10 bg-vault-darkWine text-white w-16 h-16 rounded-full flex items-center justify-center animate-bounce shadow-xl hover:bg-pink-500 transition-colors mx-auto"
                  >
                      ...
                      {data.kinder.playfulStats.map((stat: any, idx: number) => {
                          ...
                          return (
                              <div key={idx} className="bg-vault-paper p-8 rounded-[3rem] text-center border-2 border-transparent hover:border-pink-200 transition-all shadow-sm hover:shadow-xl group">
                                  ...
                                  <p className="text-4xl font-black text-vault-darkWine mb-1 italic">{stat.value}</p>
      ...
      <section className="bg-vault-darkWine py-32 text-white relative overflow-hidden">
      ...
      <section className="py-32 bg-white">
          <div className="container mx-auto px-4 lg:px-12">
              <div className="text-center mb-20">
                  <h2 className="text-5xl font-black text-vault-darkWine uppercase tracking-tighter italic mb-4">{content.programsTitle}</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                  {content.programs.map((prog) => (
                      <div key={prog.name} className="group flex flex-col">
                          ...
                          <div className="px-4">
                              <h4 className="text-2xl font-black text-vault-darkWine uppercase tracking-tighter italic mb-2">{prog.name}</h4>
      ...
      <section className="py-20 px-4">
          <div className="container mx-auto max-w-6xl">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="bg-pink-500 rounded-[4rem] p-12 md:p-16 text-center text-white relative overflow-hidden shadow-2xl border-b-8 border-pink-700">
                      <div className="relative z-10 space-y-8">
                          ...
                          <Link 
                              ...
                              className="inline-block bg-white text-pink-500 px-12 py-4 rounded-full font-black uppercase tracking-widest text-xs hover:bg-vault-darkWine hover:text-white transition-all shadow-xl"
                          >
                  ...
                  {/* Enrichment Section */}
                  <div className="bg-vault-wine rounded-[4rem] p-12 md:p-16 text-center text-white relative overflow-hidden shadow-2xl border-b-8 border-vault-darkWine group">
                      <div className="relative z-10 space-y-8">
                          ...
                          <Link 
                              to="/demos/integrated/plus/kinder" 
                              className="inline-block bg-vault-yellow text-vault-darkWine px-12 py-4 rounded-full font-black uppercase tracking-widest text-xs hover:bg-white transition-all shadow-xl group-hover:-translate-y-1"
                          >
