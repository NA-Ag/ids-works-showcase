...
const Secondary: React.FC = () => {
  ...
  return (
    <>
    <div className="bg-white min-h-screen font-sans selection:bg-vault-wine/10 overflow-hidden">
      ...
      <section className="relative h-[600px] md:h-[750px] flex items-center bg-vault-darkWine overflow-hidden pt-20">
          <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(#ffffff 1px, transparent 1px)', backgroundSize: '30px 30px' }}></div>
          
          <div className="container mx-auto px-4 lg:px-12 relative z-20">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  <div className="space-y-8 animate-fade-in-left">
                      <div className="inline-flex items-center gap-2 bg-vault-yellow text-vault-darkWine px-4 py-1 rounded-sm font-black text-[10px] tracking-widest uppercase">
                      ...
                      <div className="pt-4 flex flex-wrap gap-4">
                          <button 
                            ...
                            className="bg-white text-vault-darkWine px-10 py-4 rounded-sm font-black uppercase tracking-widest text-xs hover:bg-vault-yellow transition-all shadow-xl"
                          >
                              {isEn ? "VIEW CURRICULUM" : "VER CURRÍCULO"}
                          </button>
                          <Link 
                            to="/demos/integrated/contact"
                            className="border-2 border-white/30 text-white px-10 py-4 rounded-sm font-black uppercase tracking-widest text-xs hover:bg-white hover:text-vault-darkWine transition-all"
                          >
                  ...
                  <div className="relative h-[450px] md:h-[550px] hidden lg:block">
                      ...
                      <div className="absolute left-0 bottom-0 w-[45%] h-[45%] bg-white rounded-2xl shadow-2xl flex flex-col items-center justify-center p-8 border-4 border-vault-wine transform -rotate-3 text-vault-darkWine">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                  {data.secondary.stats.map((stat: any, idx: number) => (
                      <div key={idx} className="bg-white p-10 rounded-2xl shadow-sm border border-gray-100 text-center hover:shadow-md transition-shadow group">
                          <p className="text-5xl font-black text-vault-darkWine mb-2 italic tracking-tighter group-hover:text-idsRed transition-colors">{stat.value}</p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                  <div className="space-y-10">
                      <div className="space-y-4">
                          ...
                          <div className="h-1.5 w-32 bg-vault-wine"></div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 gap-4 pt-4">
                          {['Authorized IB World School', 'Cambridge International Certification', 'Specialized Science & Technology Labs'].map((item, i) => (
                              <div key={i} className="flex items-center gap-4 text-vault-darkWine font-black uppercase tracking-widest text-[11px] bg-gray-50 p-4 rounded-xl border-l-4 border-vault-wine">
      ...
      {/* 4. CURRICULUM TRACKS */}
      <section ref={curriculumRef} className="bg-vault-darkWine py-32 text-white relative overflow-hidden border-y-8 border-vault-yellow">
          ...
          <div className="container mx-auto px-4 lg:px-12 relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {data.secondary.tracks.map((track: any, idx: number) => (
                      <div key={idx} onClick={() => setSelectedStage(track)} className="bg-white/5 p-10 rounded-2xl border border-white/10 hover:bg-white hover:text-vault-darkWine transition-all group cursor-pointer flex flex-col justify-between h-full border-b-8 hover:border-vault-yellow">
                          <div>
                          ...
                          <span className="text-vault-yellow font-black text-[10px] uppercase tracking-widest flex items-center gap-2 group-hover:text-vault-wine">
      ...
      <section className="py-24 px-4 bg-gray-50">
          <div className="container mx-auto max-w-6xl">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  {/* Admissions CTA */}
                  <div className="bg-white rounded-[3rem] p-12 md:p-16 text-center relative overflow-hidden shadow-2xl border border-gray-100 border-b-8 border-vault-wine group">
                      <div className="relative z-10 space-y-8">
                          ...
                          <Link 
                              ...
                              className="inline-block bg-vault-darkWine text-white px-12 py-4 rounded-sm font-black uppercase tracking-widest text-xs hover:bg-idsRed transition-all shadow-xl"
                          >
                  ...
                  {/* Enrichment Section */}
                  <div className="bg-vault-darkWine rounded-[3rem] p-12 md:p-16 text-center text-white relative overflow-hidden shadow-2xl border-b-8 border-vault-yellow group">
                      <div className="relative z-10 space-y-8">
                          ...
                          <Link 
                              to="/demos/integrated/plus/secondary" 
